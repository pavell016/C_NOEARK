...
namespace SensorsTransit
{
    ...
    class SensorsCiutat
    {
        ...
        public void RebreDadesSensors()
        {
            ...
            //}
                ...
                Parallel.For(0, NumSensors, delegate (int i)
                {
                    lock (locker) {
                        SensorsLocal.Add(Sensors[i].EnviaDadesCentral());
                    }
        ...
        public void ResetSensors()
        {
            ...
            Parallel.ForEach(Sensors, delegate (Sensor S) {
                S.Connecta();
                S.Reset();
            });
        ...
        public void OrdenaVehicles()
        {
            ...
            while (canvi)
            {
                ...
                //    }
                //}
                Parallel.For(0, NumSensors - 1, delegate (int i) {
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Task mitjana = Task.Run(() => {
            //    Console.WriteLine("Calculant mitjana");
            //    SensorsBCN.CalcularMitjana();
            //    Console.WriteLine("Mitjana vehicles: {0}", SensorsBCN.MitjanaVehicles);
            //});
            Thread mitjana = new Thread(SensorsBCN.CalcularMitjana);
            mitjana.Start();
            ...
            //    Console.WriteLine("Max vehicles: {0}", SensorsBCN.MaxVehicles);
            //});
            Thread maxV = new Thread(SensorsBCN.CalcularMaxVehicles);
            maxV.Start();
            ...
            //    SensorsBCN.MostraDadesOrdenades();
            //});
            Thread orden = new Thread(SensorsBCN.OrdenaVehicles);
            orden.Start();
            orden.Join();
            SensorsBCN.MostraDadesOrdenades();
            mitjana.Join();
            ...
            //Task.WaitAll(mitjana, MAXV, orden);
