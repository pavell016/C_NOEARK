...
namespace ex3
{
    class main
    {
        ...
        static ManualResetEvent tasca23 = new ManualResetEvent(false);
        ...
        {
            tasca23.WaitOne(); //espera a la senyal que s'han acabat les tasques 2 i 3
        ...
        public static void Main(string[] args)
        {
            ...
            //com que ja han acabat les tasques 2 i 3 es dona pas a les 4 i 5
            tasca23.Set();
